...
public class ExpenseReport extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Any", "Raw Supplies", "Drawing", "Utility Expense", "Wholesales", "Kitchenwares" }));
        ...
        jLabel156.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/expense3.png"))); // NOI18N
        ...
        jLabel157.setText("Expense Reports");
        ...
        jLabel15.setText("- View expense reports");
        ...
        jLabel10.setText("Expense Category");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try (java.sql.Connection con = java.sql.DriverManager.getConnection(Externs.host, Externs.username, Externs.password)) {
            if (jComboBox1.getSelectedItem() == "Any") {
                SQL = "SELECT * FROM EXPENSE WHERE "
                        + "REGDATE >= '" + startDate + "' "
                        + "AND REGDATE <= '" + endDate + "' "
                        + "ORDER BY DESCRIPTION ASC";
            } else {
                SQL = "SELECT * FROM EXPENSE WHERE "
                        + "EXPENSETYPE = '" + (String) jComboBox1.getSelectedItem() + "' "
            ...
            int count = 0;
            while (rs.next()) {
                jTable1.setValueAt(rs.getDate("REGDATE"), count, 0);
                jTable1.setValueAt(rs.getString("DESCRIPTION"), count, 1);
                jTable1.setValueAt(rs.getString("PRICE"), count, 2);
                jTable1.setValueAt(rs.getString("EXPENSETYPE"), count, 3);
                count++;
