...
/**
 * by Martin_Konicek downloaded from
...
public class Password {
    ...
    /**
     * The higher the number of iterations the more expensive computing the hash
     * is for us and also for a brute force attack.
     */
    ...
    public static String encrypt(String password) throws Exception {
        byte[] salt = java.security.SecureRandom.getInstance("SHA1PRNG").generateSeed(saltLen);
    ...
    private static String hash(String password, byte[] salt) throws Exception {
        ...
        javax.crypto.SecretKeyFactory f = javax.crypto.SecretKeyFactory.getInstance("PBKDF2WithHmacSHA1");
        javax.crypto.SecretKey key = f.generateSecret(new javax.crypto.spec.PBEKeySpec(
